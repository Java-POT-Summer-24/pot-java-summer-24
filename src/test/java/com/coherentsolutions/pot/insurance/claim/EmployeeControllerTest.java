...
class EmployeeControllerTest {
    ...
    void testUpdateEmployee() {
        ...
        EmployeeDTO result = employeeController.updateEmployee(originalEmployeeDTO.getEmployeeId(), originalEmployeeDTO);

        assertEquals(updatedEmployeeDTO, result);
        verify(employeeService).updateEmployee(originalEmployeeDTO.getEmployeeId(), originalEmployeeDTO);
    }
